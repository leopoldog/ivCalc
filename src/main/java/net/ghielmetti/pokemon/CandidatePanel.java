...
public class CandidatePanel extends JPanel {
  private static final Color FULL_GOOD = new Color(150, 255, 150);
  private static final Color FULL_BAD  = new Color(255, 150, 150);
  ...
  public CandidatePanel(final Item inItem, final Integer inCP, final List<Pair<Integer, IVLevel>> inCandidates) {
    ...
    addPanelHeader(inItem);
    addTableHeader();
    addCandidates(inItem, inCP, inCandidates);
  }

  private void addCandidates(final Item inItem, final Integer inCP, final List<Pair<Integer, IVLevel>> inCandidates) {
    int y = 2;
    for (Pair<Integer, IVLevel> candidate : inCandidates) {
      ...
      boolean isHalfLevel = (candidate.getLeft().intValue() & 1) != 0;

      bgColorLevel = isHalfLevel ? isBad ? HALF_BAD : HALF_GOOD : isBad ? FULL_BAD : FULL_GOOD;
      bgColorInfos = isBad ? FULL_BAD : FULL_GOOD;

      add(toLabel(Double.toString(candidate.getLeft().doubleValue() / 2.0), bgColorLevel, SwingConstants.CENTER), new GridBagConstraints(0, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel(candidate.getRight().toString(), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(1, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel(Integer.toString(candidate.getRight().getAttack()), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(2, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel(Integer.toString(candidate.getRight().getDefense()), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(3, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel(Integer.toString(candidate.getRight().getStamina()), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(4, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel("%" + Integer.toString((int) (((candidate.getRight().getTotal() / 45.0) * 100.0) + 0.5)), bgColorInfos, SwingConstants.CENTER),
      ...
      if (minMaxCP.getLeft().equals(minMaxCP.getRight())) {
        ...
        cpPct = (inCP.doubleValue() - minMaxCP.getLeft().doubleValue()) / (minMaxCP.getRight().doubleValue() - minMaxCP.getLeft().doubleValue());
      }

      add(toLabel(minMaxCP.getLeft().toString(), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(6, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel(minMaxCP.getRight().toString(), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(7, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      add(toLabel("%" + Double.toString((int) ((cpPct * 100000.0) + 0.5) / 1000.0), bgColorInfos, SwingConstants.CENTER), new GridBagConstraints(8, y, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
      y++;
    }
  }

  private void addPanelHeader(final Item inItem) {
